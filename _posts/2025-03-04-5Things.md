...
Throughout the project, I developed a stronger understanding of backend API development and database management. My strengths included problem-solving, as I often had to debug issues with API requests and responses, and perseverance, as I continuously refined features like flashcard updating and deck organization. However, I realized that my communication and team collaboration skills needed improvement. At times, I struggled to clearly explain my changes to the team, which led to minor setbacks in our workflow.

Moving forward, I want to work on being more proactive in team discussions, ensuring that everyone is aligned when implementing new features, because towards the beginning we were more seperated than connected as a group.
